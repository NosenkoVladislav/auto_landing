$(document).ready(function() {
	...
	$(".mc_toggle").click(function() {
		if($(this).parent().children("ul").is(":visible"))	{
		 ...
		 $(this).parent().children(".mc_item_wrap_af").hide();
	} else {
		$(".mc item .mc_item_wrap > ul .mc_item_wrap_af").hide();
		$(".mc_item_wrap").removeClass("active");
		$(this).parent().addClass("active");
		$(this).parent().children("ul").slideDown();
		$(this).parent().children(".mc_item_wrap_af").show();
		}
	});
	...
	var eqElement = ".home_items, .sb_content > div"
